int LedOut = 13; //ορισμός pin 14 ελέγχου του φάρου
int light_pin = A0; //pin για μέτρηση στάθμης φωτός
int temp_pin = A1; //pin για μέτρηση θερμοκρασίας
int move_pin = 8; //pin για ανίχνευση κίνησης
...
void loop(){
  if(millis() >= previous1){
    ...
    analog_value=map(value,512,1023,0,255); //-228 έως 230
    Serial.print("Brightness value is = ");
    Serial.println(analog_value);
    previous1 = millis() + 1000; //κάθε 10 sec μέτρηση
  }
